    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Пользователь с таким именем уже существует.'}, help_text='Обязательное, не более 200 символов', max_length=200, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='Имя пользователя')),
                ('email', models.EmailField(help_text='Обязательное, не более 200 символов', max_length=200, unique=True, verbose_name='Почта')),
                ('first_name', models.CharField(help_text='Обязательное, не более 200 символов', max_length=200, verbose_name='Имя')),
                ('last_name', models.CharField(help_text='Обязательное, не более 200 символов', max_length=200, verbose_name='Фамилия')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'author'), name='unique_name_following')],
            },
        ),
    ]
